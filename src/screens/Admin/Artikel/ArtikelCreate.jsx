...
export default function ArtikelCreate() {
    ...
    const onSave = async (event) =>{
        ...
        axios({
            ...
            .then(() => {
                toast.success("artikel successfuly created");
                setTimeout(() => {
                ...
                <nav className="flex" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Artikel</span>
                        </div>
                        </li>
