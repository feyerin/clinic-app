...
export default function BeritaEdit() {
    ...
    const getData = async() => {
        try {
            ...
            const obj = {
                ...
                writer: "",
                thumbnail: res.data.data.news_image,
                title: res.data.data.news_title,
                content: ""
            }
            setObj(obj);
            setValue(res.data.data.news_content);
        } catch (error) {
          console.log(error);
        }
    }
    ...
    const onSave = async (event) => {
        ...
        axios({
            ...
            .then(() => {
                toast.success("berita successfuly updated");
                setTimeout(() => {
                ...
                <nav className="flex" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Berita</a>
                        </div>
                        </li>
