...
export default function AdminLayout() {
    ...
    return (
        <div>
            <div className="sticky top-0 bg-white xl:hidden flex justify-between w-full h-14 p-6 shadow-md">
                    ...
                    <div className="mt-0 justify-start items-center pl-4 w-full border-gray-600 pb-5 ">
                        <ul className="space-y-2">
                            ...
                            <li>
                                ...
                                <Link to={"/clinic-app/admin/layanan"}>
                                    <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        ...
                                        <p className="text-base leading-4  ">Layanan</p>
                                    </button>
                                </Link>
                                <Link to={"/clinic-app/admin/dokter"}>
                                    <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        ...
                                        <p className="text-base leading-4  ">Dokter</p>
                                    </button>
                                </Link>
                                <Link to={"/clinic-app/admin/cabang"}>
                                    <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <p className="text-base leading-4  ">Cabang</p>
                                    </button>
                                </Link>
                                </div>
                            </li>
