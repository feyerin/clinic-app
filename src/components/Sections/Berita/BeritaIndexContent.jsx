      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl lg:mx-0">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Berita Kesehatan</h2>
                ...
                data.map((item, index) => (
                    <article key={index} className="flex max-w-xl flex-col items-start justify-between">
                        <div className=" items-center gap-x-4 text-xs ">
                            <div className="pb-4">
                                <img className="rounded-lg" crossOrigin="anonymous" src={`${process.env.REACT_APP_BASE_URL}/api/image/${item.news_image}`} alt="https://dummyimage.com/400x250/b9bad4/fff" />
                            </div>
                        </div>
                        <div className="group relative">
                            <h3 className="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                                <Link to={`/berita-content?id=${item.id}`}>
                                    <a href="">
                            ...
                            <p className="mt-5 text-sm leading-6 text-gray-600 line-clamp-3" dangerouslySetInnerHTML={{ __html: item.news_content }}></p>
                            </div>
                    </article>
                ))}
