          ...
          <div className="shadow items-center py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className=" lg:grid lg:grid-cols-2 gap-16 ">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                  <img className="w-full rounded-lg animate-fade-right animate-once animate-delay-100 animate-ease-in" src={fasilitas2} alt="office content 1"/>
                  <img className="mt-4 w-full lg:mt-10 rounded-lg animate-fade-right animate-once animate-delay-100 animate-ease-in" src={fasilitas6} alt="office content 2"/>
              </div>
            </div>
