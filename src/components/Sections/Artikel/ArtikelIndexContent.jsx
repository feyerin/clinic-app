                ...
                <div className="bg-white py-12 shadow-md">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Health & Wellness Artikel</h2>
                        ...
                        <div className="mx-auto mt-12 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 border-t border-gray-200 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                            {data.map((post, index) => (
                                <a href={`artikel-content?id=${post.id}`} key={index} className="flex flex-col justify-between shadow-sm hover:shadow-2xl rounded-lg">
                                    <div className="pb-4">
                                        <img className="rounded-t-lg" crossOrigin="anonymous" src={`${process.env.REACT_APP_BASE_URL}/api/image/${post.article_image}`} alt="https://dummyimage.com/400x250/b9bad4/fff" />
                                    </div>                                 
                                    <div className="flex flex-row justify-between text-xs mt-2 px-4"> 
                                    ...
                                    <div className="w-full bg-white h-1 mb-2 px-4">
                                        <div className="bg-primary h-1" style={{width: "20%"}}></div>
                                    </div>
                                    <div className="group relative px-4 pb-2">
                                        ...
                                        <p className="mt-5 text-sm font-sans text-gray-600 line-clamp-3" dangerouslySetInnerHTML={{ __html: post.article_content }}></p>
                        ...
                        {data.length === 0 && (
                            <div className="mx-auto max-w-full lg:mx-0 text-center py-40">
                                ...
                                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Artikel tidak Ditemukan</h2>
                                <p className="mt-2 text-lg leading-8 text-gray-600">
                                    Tunggu Artikel & Berita Menarik tentang kesehatan lainnya.
                                </p>
                        </div>
                        )}
                    </div>
