                ...
                <article className="flex flex-col shadow my-4">
                    <div className="bg-white flex flex-col justify-start p-6">
                     ...
                     <div className="grid grid-cols-2 gap-6 p-6">
                            <div>
                                <img src={fasilitas12} className="rounded h-56 animate-fade-right animate-once animate-delay-100 animate-ease-in" crossOrigin="anonymous"/>
                            </div>
                            <div>
                                <img src={fasilitas13} className="rounded h-56 animate-fade-right animate-once animate-delay-100 animate-ease-in" crossOrigin="anonymous"/>
                            </div>
                        </div>
