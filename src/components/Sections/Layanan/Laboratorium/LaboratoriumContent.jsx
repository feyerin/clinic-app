...
export default function LaboratoriumContent() {
            ...
            <section className="w-full md:w-2/3 flex flex-col items-center px-3">
                <article className="flex flex-col shadow my-4">
                    <div className="bg-white flex flex-col justify-start p-6">
                        <span className="mb-2 text-4xl tracking-tight font-extrabold text-gray-900">Layanan Laboratorium </span>
                    ...
                    <div className='p-6 bg-white'>
                        ...
                        <div className="grid grid-cols-2 gap-6 mt-7 pr-4">
                            <div>
                                <img src={fasilitas10} className="rounded h-56 animate-fade-right animate-once animate-delay-100 animate-ease-in" crossOrigin="anonymous"/>
                            </div>
                            <div>
                                <img src={fasilitas11} className="rounded h-56 animate-fade-right animate-once animate-delay-100 animate-ease-in" crossOrigin="anonymous"/>
                            </div>
                        </div>
